...
LedControl LEDarray=LedControl(12,13,15,1); // LedControl(DIN,CLK,CS,DIVCEnum)->(D6,D7,D8)
/*arrow number
								   M
								1     6  
								2     5
...
void display_num(int n){
	...
	byte num2[8] = {                                    
		0b00010000,0b00110000,0b01111111,0b11111111,  //  no.2 arrow
		0b01111111,0b00110000,0b00010000,0b00000000};
	byte num3[8] = {                                   
		0b00000100,0b10001110,0b11011111,0b11111110,  //  no.3 arrow
		0b11111100,0b11111000,0b11111100,0b11111110};
	byte num4[8] = {                                   
		0b00100000,0b01110001,0b11111011,0b01111111,  //  no.4 arrow
		0b00111111,0b00011111,0b00111111,0b01111111};
	byte num5[8] = {                                  
		 0b00001000,0b00001100,0b11111110,0b11111111,  // no.5 arrow
		 0b11111110,0b00001100,0b00001000,0b00000000};
	byte num6[8] = {                                  
		0b01111111,0b00111111,0b00011111,0b00111111,  //  no.6 arrow
